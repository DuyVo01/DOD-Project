...
namespace Facade.Tweening
{
    public static class Tweener
    {
        ...
        // Movement operations
        public static ITween DoAnchoredPos(RectTransform target, [Bridge.Ref] Vector2 endValue, float duration)
        {
...
[Bridge.Ref]             Vector2 startValue,
[Bridge.Ref]             Vector2 endValue,
            float duration
        )
        {
        ...
        // Scale operations
        public static ITween DoScale(Transform transform, [Bridge.Ref] Vector3 targetScale, float duration)
        {
        ...
        public static ITween DoScale(
            Transform target,
[Bridge.Ref]             Vector3 startValue,
[Bridge.Ref]             Vector3 endValue,
            float duration
        )
        {
        ...
        public static ITween DoRotate(Transform target, [Bridge.Ref] Vector3 endValue, float duration)
        {
