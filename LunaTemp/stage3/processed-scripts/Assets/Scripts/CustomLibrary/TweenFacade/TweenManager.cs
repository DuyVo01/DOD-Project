...
namespace Facade.Tweening
{
    public class TweenManager : PersistentSingleton<TweenManager>
    {
        ...
        public ITween DoAnchoredPos(RectTransform target, [Bridge.Ref] Vector2 endValue, float duration)
        {
            if (_currentLibrary == TweenLibrary.DOTween)
            {
        ...
        // Scale a Transform
        public ITween DoScale(Transform target, [Bridge.Ref] Vector3 endValue, float duration)
        {
            if (_currentLibrary == TweenLibrary.DOTween)
            {
        ...
        public ITween DoRotate(Transform target, [Bridge.Ref] Vector3 endValue, float duration)
        {
            if (_currentLibrary == TweenLibrary.DOTween)
            {
