...
namespace ECS_MagicTile
{
    public class MusicNoteSyncer : ArchetypeSyncer
    {
        ...
        private void SyncNoteState(
            int entityId,
            GameObject view,
[Bridge.Ref]             MusicNoteComponent note,
[Bridge.Ref]             MusicNoteInteractionComponent interaction,
[Bridge.Ref]             MusicNoteFillerComponent filler
        )
        {
        ...
        private void SyncNoteFiller(int entityId, GameObject view, [Bridge.Ref] MusicNoteFillerComponent filler)
        {
