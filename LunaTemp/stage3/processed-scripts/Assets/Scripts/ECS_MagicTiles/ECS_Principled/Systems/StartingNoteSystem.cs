...
namespace ECS_MagicTile
{
    public class StartingNoteSystem : IGameSystem
    {
        ...
        public void RunInitialize()
        {
            ...
            startingNoteStorage = startingNoteStorage ?? World.GetStorage(Archetype.Registry.StartingNote);
            perfectLineStorage = perfectLineStorage ?? World.GetStorage(Archetype.Registry.PerfectLine);
